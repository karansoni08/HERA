...
def map_outcome(row):
    mapping = {"Very Low":"negligible impact","Low":"limited operational impact","Medium":"localized business impact","High":"material business impact","Critical":"severe financial/reputational impact"}
